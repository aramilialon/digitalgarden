...
Let's see how I created my very first pipeline!
...
1. I would like to be able to host on Git the source code, so I can apply merge protection (you may never know that by chance I upload something I would not like to be seen)
...
I know, there's room for improvement, but the actions done are simple:
